...
class TaskBrief extends StatefulWidget {
  ...
  final String taskId;
  const TaskBrief({Key? key, required this.data, required this.taskId})
      : super(key: key);
  ...
  Future<void> getTaskDocument(String docId) async {
    try {
      DocumentSnapshot docSnapshot =
          await firestore.collection('Tasks').doc(docId).get();
                          ...
                          SizedBox(
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomText(
                                    text: 'View On Maps', color: Colors.blue),
                              ],
                            ),
                          )
                        ],
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => Bid(
                                              ...
                                              postOwner: taskData['user_id'],
                                              taskTitle: taskData['title'],
                                              offers: taskData['offers'],
                                            )));
                              },
                              child: Container(
                                width: 150,
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              width: 170,
                              child: taskData.isNotEmpty
                                  ? Text(taskData['videoPath'],
                                      overflow: TextOverflow.ellipsis,
                                      style: const TextStyle(
                                        color: Colors.white,
                                      ))
                                  : const Center(
                                      child: CustomText(text: 'No video')),
                            ),
                          ),
                        ],
                      ),
